Feature: nopCommerce HW#1
  
  Scenario: Nop Commerce - Test the shopping cart
    ...
    Then I click on element with xpath "//td[contains(a/text(),'Fahrenheit 451 by Ray Bradbury')]/..//button[@class='remove-btn']"
